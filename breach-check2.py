                ...
                try:
                    ...
                    if variation > threshold:
                        ...
                        print(colored(
                            ...
                            f"{base_size} → {current_size} bytes (payload: {test_str[:20]}{'...' if len(test_str) > 20 else ''})",
                            "red"))
...
def main():
    parser = argparse.ArgumentParser(description='BREACH Vulnerability Tester (CVE-2013-3587)')
    ...
    print("\n" + "="*60)
    print(colored("BREACH Vulnerability Tester (CVE-2013-3587) Extended", "cyan", attrs=["bold"]))
    print("="*60)
